...
import { A2S1, A2S2, A2S3, A2S4, A2S5, A2S6, A2S7, A2S8, A2S9 } from "../albums/albumsList/album2/A2Songs";
    ...
    return (
        <div>
            <Routes>
                ...
                {/* Song Routes -- Album2 */}
                <Route path='/album2/1' element={<A2S1 />} />
                <Route path='/album2/2' element={<A2S2 />} />
                <Route path='/album2/3' element={<A2S3 />} />
                <Route path='/album2/4' element={<A2S4 />} />
                <Route path='/album2/5' element={<A2S5 />} />
                <Route path='/album2/6' element={<A2S6 />} />
                <Route path='/album2/7' element={<A2S7 />} />
                <Route path='/album2/8' element={<A2S8 />} />
                <Route path='/album2/9' element={<A2S9 />} />
                {/* Song Routes -- Album3 */}
